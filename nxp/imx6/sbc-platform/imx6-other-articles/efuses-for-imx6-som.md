...
2. Download the SolidRun-MicroSOM-Fusing.zip archive and unzip it to a known location. (Download from [i.MX6 SOM Hardware User Manual](/nxp/imx6/com-som/imx6-som-hardware-user-manual.md)  page)
