...
The difference between this page and the older page [eFuses for i.MX6 SOM](/nxp/imx6/sbc-platform/imx6-other-articles/efuses-for-imx6-som.md)  is that the later demonstrates how to blow fuses of i.MX6 to boot in a production line, rather a developer friendly environment.
...
6. USB host to host cable – refer to [eFuses for i.MX6 SOM](/nxp/imx6/sbc-platform/imx6-other-articles/efuses-for-imx6-som.md)  USB host to host cable preparation
