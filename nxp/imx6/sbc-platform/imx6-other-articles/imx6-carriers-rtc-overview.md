...
A real-time clock (RTC) is a computer clock that keeps track of the current time. The RTC circuitry is integrated into the [HummingBoard Professional](../hummingboard-imx6-sbc-quick-start-guide/hummingboard-pro-quick-start-guide.md) and the [Cubox-i](../cubox-i-quick-start-guide.md) uses a CR1620 sized Lithium/Manganese Dioxide (LiMnO²) Coin Cell.

This coin cell should be the only part to connect to the header provided on the device to power this circuit.

<a id="general-requirement"></a>
