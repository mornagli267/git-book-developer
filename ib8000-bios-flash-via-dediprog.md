...
| Table of Contents | - [Revision and Notes](#revision-and-notes)<br>- [DediProg SF600 Intel Solid PC BIOS update/flashing guide](#dediprog-sf600-intel-solid-pc-bios-update-flashing-guide)<br>  - [Requirements](#requirements)<br>  - [Instructions](#instructions)<br>  - [External Links](#external-links) |     |     |

<a id="dediprog-sf600-intel-solid-pc-bios-update-flashing-guide"></a>
...
![](./attachments/image-20220418-153455.png)

![](./attachments/image-20220418-153527.png)

![](./attachments/image-20220418-153623.png)

![](./attachments/image-20220418-153714.png)
...
> [!WARNING]
> **Please Note:**
> The programmer must drive 1.8v signals; otherwise the main processor might get damaged

![](./attachments/image-20220418-153305.png)
...
![](./attachments/image-20220418-153233.png)
