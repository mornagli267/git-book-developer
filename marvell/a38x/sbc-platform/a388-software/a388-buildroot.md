...
2\. Set the Clearfog board DIP switches to boot from SD. See the [ClearFog A388 Boot Select](/marvell/a38x/sbc-platform/a388-other-articles/clearfog-a388-boot-select.md)  article for details.
