...
- [CN913x U-Boot Documentation](../cn913x-other-articles/u-boot-for-cn913x.md) on how to install U-Boot to any of the supported boot media
- [CN913x TLV EEPROM Documentation](../cn913x-other-articles/cn913x-eeprom-programming-tlv.md) on programming the Carrier and SoM EEPROMs for device identification.
