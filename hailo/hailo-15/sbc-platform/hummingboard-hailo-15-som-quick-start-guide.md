...
{% hint style="info" %}
For more detailed information about Hailo 15 SOM, please visit the hardware user manual: [HAILO 15 SOM Hardware User Manual](../com-som/hailo-15-som-hardware-user-manual.md)
{% endhint %}
