...
| Table of Contents | <p>- <a href="pinout-planner-tool-guide.md#revisions-and-notes">Revisions and Notes</a><br>- <a href="pinout-planner-tool-guide.md#overview">Overview</a><br>- <a href="pinout-planner-tool-guide.md#features">Features</a><br>- <a href="pinout-planner-tool-guide.md#system-requirements">System Requirements</a><br>- <a href="pinout-planner-tool-guide.md#user-interface-ui-description">User Interface (UI) Description</a><br>- <a href="pinout-planner-tool-guide.md#the-title-bar">The Title Bar</a><br>- <a href="pinout-planner-tool-guide.md#the-header-bar">The Header Bar</a><br>- <a href="pinout-planner-tool-guide.md#the-function-section">The ‘Function’ Section</a><br>- <a href="pinout-planner-tool-guide.md#the-workspace-section">The ‘Workspace’ Section</a><br>- <a href="pinout-planner-tool-guide.md#the-footer-bar">The Footer Bar</a><br>- <a href="pinout-planner-tool-guide.md#getting-started">Getting Started</a><br>- <a href="pinout-planner-tool-guide.md#associating-pins-to-signals-ports-functions">Associating Pins to Signals/Ports/Functions</a><br>- <a href="pinout-planner-tool-guide.md#working-on-compatible-modules">Working on Compatible Modules</a><br>- <a href="pinout-planner-tool-guide.md#obtaining-pinout-summary">Obtaining ‘Pinout Summary’</a><br>- <a href="pinout-planner-tool-guide.md#checking-your-work">Checking Your Work</a><br>- <a href="pinout-planner-tool-guide.md#fixing-collisions-and-functional-errors">Fixing Collisions and Functional Errors</a><br>- <a href="pinout-planner-tool-guide.md#fixing-collisions">Fixing Collisions</a><br>- <a href="pinout-planner-tool-guide.md#fixing-functional-errors">Fixing Functional Errors</a><br>- <a href="pinout-planner-tool-guide.md#saving-the-current-project">Saving the Current Project</a><br>- <a href="pinout-planner-tool-guide.md#retrieving-a-saves-project">Retrieving a Saves Project</a><br>- <a href="pinout-planner-tool-guide.md#tips-and-recommendations">Tips and recommendations</a><br>- <a href="pinout-planner-tool-guide.md#restrictions">Restrictions</a></p> |              |           |
...
![](../.gitbook/assets/image-20220120-082754.png)
...
![](../.gitbook/assets/image-20220120-082800.png)
...
|   |                                                                                                                         |
| - | ----------------------------------------------------------------------------------------------------------------------- |
|   | _**Use this button very cautiously because you cannot undo a ‘Clear’ action and the local storage data will be lost.**_ |
...
![](../.gitbook/assets/image-20220120-082810.png)

![](../.gitbook/assets/image-20220120-082814.png)
...
![](../.gitbook/assets/image-20220120-082823.png)

![](../.gitbook/assets/image-20220120-082828.png)
...
![](../.gitbook/assets/image-20220120-082835.png)

![](../.gitbook/assets/image-20220120-082842.png)

![](../.gitbook/assets/image-20220120-082848.png)
...
![](../.gitbook/assets/image-20220120-083028.png)
...
![](../.gitbook/assets/image-20220120-083041.png)

To open the online copy of this user guide:

|                                                                                                                |    |                                                   |
| -------------------------------------------------------------------------------------------------------------- | -- | ------------------------------------------------- |
| 1. Click on the ‘Guide’ button.  An online copy of this guide will be opened in a new tab of your web browser. | => | ![](../.gitbook/assets/image-20220120-083054.png) |

To select a module:

|                                                                                                                                                                                                                                  |                     |                                                                                                                                               |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| <p>1. Click on the ‘Select Module’ line.  A list of all available modules will be displayed.<br>2. Select a module from the list and click on the ‘Continue’ button.<br>3. Now you can start working on the selected module.</p> | <p>=><br><br>=></p> | <p><img src="../.gitbook/assets/image-20220120-083101.png" alt=""><br><br><img src="../.gitbook/assets/image-20220120-083105.png" alt=""></p> |
...
* _The actual selection actually done upon clicking on the ‘Select’ of the corresponding entity._

To implement selections, proceed as follows:

|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |                                         |                                                                                                                                                                                                                                                                                             |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <p>1. In the ‘Functions’ section, click on the name of the function you want to work on.-<br><br>-Subordinate lines with all ports related to the function will be displayed.<br><br>- <em>The actual selection actually done upon clicking on the ‘Select’ of the corresponding entity.</em><br><br>2. Click on the port you want to select.<br><br>-Subordinate lines with all signals related to the port will be displayed.<br><br>- <em>If you click on the ‘Select’ button of a port, all its associated signals and default pins will be selected.</em><br><br>3. Click on the signal you want to select.<br><br>-Subordinate lines with all pins related to the signal will be displayed.<br><br>-The pin with a checkmark next to it is the one to be selected.<br><br>4. You may select another pin (if exists) by clicking on it.<br><br>-The checkmark will then appear next to the pin you clicked on.<br><br>5. Click on the ‘Select’ button of the signal.<br><br>-The signal will be selected, the lines of the signal, port, and function will become green, and the selection details will be added to the selection table in the ‘Workspace’ section.<br><br>6. To unselect a function/port/signal, click on the Unselect button in the line next to the corresponding name in the selection table in the ‘Workspace’ section.<br><br>-The function/port/signal and all its subordinates will be removed from the selection table in the ‘Workspace’ section, and the selection will be void.<br><br>- <em>If you want to cancel an action you just carried out, you can undo it by clicking on the ‘Undo’ button in the header bar.</em></p> | <p>=><br><br>=><br><br>=><br><br>=></p> | <p><img src="../.gitbook/assets/image-20220120-083203.png" alt=""><br><br><img src="../.gitbook/assets/image-20220120-083206.png" alt=""><br><br><img src="../.gitbook/assets/image-20220120-083209.png" alt=""><br><br><img src="../.gitbook/assets/image-20220120-083213.png" alt=""></p> |
...
_**Only some of the modules offered by SolidRun have compatible modules available.**_
...
![](../.gitbook/assets/image-20220120-083302.png)
...
![](../.gitbook/assets/image-20220120-083313.png)

![](../.gitbook/assets/image-20220120-083323.png)
...
![](../.gitbook/assets/image-20220120-083503.png)
...
![](../.gitbook/assets/image-20220120-083549.png)
...
![](../.gitbook/assets/image-20220120-083559.png)
...
1. ![](../.gitbook/assets/image-20220120-083606.png)
...
![](../.gitbook/assets/image-20220120-083650.png)
...
![](../.gitbook/assets/image-20220120-083702.png)
...
|                                                                                                                                                                                                                                                                                                                                                                                                           |                                          |                                                                                                                                               |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| <p>1. Click on the ‘Import’ button in the Header bar.<br>2. Select in the browser window that opens the requested folder and file and click on the ‘Open’ button.<br><br><br><br><br>- <em>Make sure you save your current work before by performing ‘Export’ before importing another project, because  when you import a project, the Workspace is cleared all  previous data will be deleted.</em></p> | <p>=><br><br> <br><br><br><br><br>=></p> | <p><img src="../.gitbook/assets/image-20220120-083805.png" alt=""><br><br><img src="../.gitbook/assets/image-20220120-083808.png" alt=""></p> |
