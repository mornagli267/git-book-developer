...
<a id="foreword-on-kura-versions"></a>
...
<a id="accessing-the-gateway-kura-web-interface"></a>
...
![](./attachments/image-20211226-121411.png)
...
<a id="connection-to-ethernet"></a>

## Connection to Ethernet

![](./attachments/image-20211226-121438.png)
...
<a id="connection-to-wifi"></a>

## Connection to WiFi

![](./attachments/image-20211226-121503.png)
...
![](./attachments/image-20211226-121512.png)

<a id="connection-to-cellular-network"></a>
...
3. On the ppp0 (or 2-2.1) page
  1. Set the Status as Enabled for WAN
  2. Configure the Cellular with the APN info corresponding to the info given by your operator. Here are the fields that must be configured (see screenshot below)
    1. Dial string that shall be: atd\*99\*\*<pdp context num># ex: ‘**atd\*99\*\*1#**‘
...
![](./attachments/image-20211226-121527.png)
...
<a id="gateway-connection-to-kapua"></a>
...
[More on the usage of Kapua](../../solidsense-software/kapua/using-eclipse-kapua-to-supervise-and-configure-solidsense-gateways.md)
...
![](./attachments/image-20211226-121550.png)
...
<a id="ssl-connection-between-the-gateway-kura-and-kapua"></a>
...
![](./attachments/image-20211226-121601.png)
