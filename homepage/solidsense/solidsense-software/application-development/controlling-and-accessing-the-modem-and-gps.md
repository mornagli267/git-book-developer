...
<a id="installation-and-introduction"></a>
...
<a id="controlling-the-modem-and-gps-status-interactively"></a>
...
| scan | <none> | Restart networks scan |
| init | <none> | Perform a flight mode /non flight mode cycle |
| sms | <none> | check SMS parameters |
| gps | <none> | check the GPS |
...
**nb\_retry**: This parameter is used to perform a soft reset of the modem if it does not find a network after <n> timer interval
...
> [!WARNING]
> **Please note**
> Changing the SIM requires to reset the modem or even restart the gateway to be taken into account.

<a id="using-the-modem-gps-micro-service-in-application"></a>
