# Bedrock R8000 Configuration Selector

> [!INFO]
> Please fill the [Bedrock inquiry form](https://www.solid-run.com/fanless-computers/bedrock-r7000/#evaluate-bedrock) first to register with SolidRun and begin email exchange

Make a copy of [Bedrock R8000 configuration selector for 1st order](https://docs.google.com/spreadsheets/d/1uzLNlrLR60oHPKbPtZyk0-BCPkC3c1tju-lKKAkioKY/copy)  
The configuration selector is a Google Sheets spreadsheet
...
> For these options please use [Bedrock R8000 configuration for follow-up orders](https://docs.google.com/spreadsheets/d/1YF-dj9O71R4u8Xe5-fAwY_n2Qstscsd2gDnJPr061vI/copy?usp=sharing)

![](./attachments/configurator%20instructions.jpg)
...
<a id="if-you-cant-access-google-sheets"></a>
...
- Save as PDF
- Pick accessories - [Bedrock R8000 Accessories](../../bedrock-r8000-technical-documentation/bedrock-r8000-r7000-accessories.md)
- Send both PDF and list of accessories to **bedrock.sales@solid-run.com**

![Bedrock R8000 Options.png](./attachments/Bedrock%20R8000%20Options.png)