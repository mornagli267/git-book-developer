...
> \[!INFO] SolidRun recommends using [Bedrock Tile](https://solidrun.atlassian.net/wiki/spaces/developer/pages/456851457/Bedrock+Mounting+options#bedrock-tile-mounting) which is much easier to integrate
