...
<a id="download-the-uefi-shell-iso"></a>
...
![image-20250513-085352.png](./attachments/image-20250513-085352.png)

<a id="guide-for-ubuntu"></a>

# Guide for UBUNTU

<a id="step-1-format-the-usb-drive-to-fat32"></a>
...
![image-20250513-090015.png](./attachments/image-20250513-090015.png)

3. Click the **three dots.**
4. Choose **“Format Disk…”**:![image-20250513-090237.png](./attachments/image-20250513-090237.png)

![image-20250513-090527.png](./attachments/image-20250513-090527.png)

5. Click **Format** . (if its ask you are you sure you want to format the disk you can click format..)

<a id="step-2-create-a-fat32-partition-on-the-usb-after-disk-format"></a>
...
![image-20250513-091231.png](./attachments/image-20250513-091231.png)
...
![image-20250513-091702.png](./attachments/image-20250513-091702.png)
...
3. Your USB will now appear in the **Files app** as a mounted drive.![image-20250513-091841.png](./attachments/image-20250513-091841.png)

<a id="step-3-mount-the-uefi-shell-iso-and-copy-the-efi-folder"></a>
...
2. mount the iso by right click and choose "Open With Disk Image Mounter"![image-20250513-092206.png](./attachments/image-20250513-092206.png)
...
6. Paste the efi folder in the **root** of the USB![image-20250513-092519.png](./attachments/image-20250513-092519.png)
...
2. Open **File Explorer**, right-click your USB, and select **Format**.![image-20250513-094818.png](./attachments/image-20250513-094818.png)
3. In the Format window, choose:
  - **File system:** `FAT32`
  - **Volume label:** `EFI-USB` (or any name)
  - ✅ Check “Quick Format”
    - Click **Start** → then confirm the warning.![image-20250513-095032.png](./attachments/image-20250513-095032.png)
![image-20250513-095119.png](./attachments/image-20250513-095119.png)

<a id="step-2-mount-the-iso-and-copy-the-files"></a>

## Step 2: Mount the ISO and Copy the Files

1. **Double-click** the downloaded ISO file (UEFI-Shell…RELEASE.iso)  
It will **automatically mount** as a virtual DVD drive in File Explorer.![image-20250513-101812.png](./attachments/image-20250513-101812.png)
2. Open the mounted ISO from the **sidebar** in File Explorer if not open automatic (it looks like a CD/DVD drive).
3. Copy all contents.![image-20250513-101909.png](./attachments/image-20250513-101909.png)
