...
<a id="option-1-update-from-windows-gui-easiest"></a>
...
<a id="option-2-update-from-windows-cmd"></a>
...
<a id="option-3-usb-drive-using-uefi-advanced"></a>

## Option 3: USB Drive using UEFI (advanced)

- Copy the files to the USB Drive you created in the [Create EFI shell bootable USB drive](../bios-bedrock-v3000/how-to-create-an-efi-shell-bootable-usb-drive.md) section
