...
![](./attachments/image-20211024-110721.png)
...
| --- | --- |
| I/Os | 2 x USB 3.0 |
| Networking | 1 x Ethernet RJ45 10/100/1000  <br>1 x 802.11 a/b/g/n/ac WiFi and Bluetooth (Optional) |
| Processor | NXP i.MX8M Plus Quad core Arm Cortex A53 up to 1.8GHz (with Arm M7 GPP) |
| Memory & Storage | Up to 3GB LPDDR4  <br>8GB eMMC  <br>MicroSD |
| Display | HDMI |
| Misc. | GPIO button  <br>Indication LEDs  <br>RTC  <br>IR receiver |
| Development and Debug interfaces | Micro USB |
| Power | 12V  <br>Optional PoE |
...
![](./attachments/image-20211024-111204.png)

<a id="visual-features-overview"></a>

#### Visual Features Overview

![](./attachments/image-20211024-144544.png)
...
| **OS** |     |
| --- | --- |
| ![](./attachments/image-20211024-150854.png) | [Documentation/debian-11\_sr8.md at bsp](https://github.com/SolidRun/documentation/blob/bsp/imx8/debian-11_sr8.md) |
| ![](./attachments/image-20211024-151110.png) | [GitHub - SolidRun/meta-solidrun-arm-imx8 at zeus-imx8mp](https://github.com/SolidRun/meta-solidrun-arm-imx8/tree/zeus-imx8mp) |
| ![](./attachments/image-20211024-151020.png) | [Cubox-M Android](https://solidrun.atlassian.net/wiki/spaces/developer/pages/261488680) |
| ![](./attachments/image-20211024-150920.png) | [GitHub - SolidRun/imx8mp\_build](https://github.com/SolidRun/imx8mp_build) |
...
|     | File | Modified |
| --- | --- | --- |
| Labels<br><br>- No labels<br>- [Edit Labels](#section-53f9d402-68fd-4f68-829d-485c0b5d9db3)<br><br>[Preview] [View](/wiki/download/attachments/200015887/CuBox-M-Schematics-v1.1.zip?version=1) [Properties](/wiki/pages/editattachment.action?pageId=200015887&fileName=CuBox-M-Schematics-v1.1.zip&isFromPageView=true) [Delete](/wiki/pages/confirmattachmentremoval.action?pageId=200015887&fileName=CuBox-M-Schematics-v1.1.zip) | ZIP Archive [CuBox-M-Schematics-v1.1.zip](/wiki/download/attachments/200015887/CuBox-M-Schematics-v1.1.zip?api=v2) | Mar 13, 2024 by [Yazan Shhady](/wiki/people/5f67bce9ed55c7006abc6319) |
...
|     | File | Modified |
| --- | --- | --- |
| Labels<br><br>- No labels<br>- [Edit Labels](#section-e8ddd31b-8621-4e9c-8c6f-fa6d19ccf2a9)<br><br>[Preview] [View](/wiki/download/attachments/200015887/CuBox-M-Schematics-v1.1.zip?version=1) [Properties](/wiki/pages/editattachment.action?pageId=200015887&fileName=CuBox-M-Schematics-v1.1.zip&isFromPageView=true) [Delete](/wiki/pages/confirmattachmentremoval.action?pageId=200015887&fileName=CuBox-M-Schematics-v1.1.zip) | ZIP Archive [CuBox-M-Schematics-v1.1.zip](/wiki/download/attachments/200015887/CuBox-M-Schematics-v1.1.zip?api=v2) | Mar 13, 2024 by [Yazan Shhady](/wiki/people/5f67bce9ed55c7006abc6319) |
