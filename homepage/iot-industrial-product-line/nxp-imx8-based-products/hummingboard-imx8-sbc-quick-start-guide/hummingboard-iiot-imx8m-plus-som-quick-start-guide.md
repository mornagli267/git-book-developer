...
![IIOT Sideways.png](<../../../../.gitbook/assets/IIOT Sideways.png>)
...
| Table of Contents | <p>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#introduction">Introduction</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#revision-and-notes">Revision and Notes</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#hardware-setup">Hardware Setup</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#product-specifications">Product specifications</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#hummingboard-iiot">HummingBoard IIOT</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#block-diagram">Block Diagram</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#visual-features-overview">Visual features overview</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#software-setup">Software Setup</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#cable-setup-and-prerequisites">Cable setup and prerequisites</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#boot-select">Boot Select</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#booting-from-sd-card">Booting from SD card</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#boot-select">Boot Select</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#final-stages">Final stages</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#programming-emmc">Programming eMMC</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#more-features">More Features</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#internet">Internet</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#wifi">WiFi</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#bluetooth">Bluetooth</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#cellular-modem">Cellular Modem</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#spi">SPI</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#basler-camera">Basler Camera</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#tlv-eeprom-support">TLV EEPROM Support</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#mac-address">MAC Address</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#list-of-supported-os">List Of Supported OS</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#build-from-source">Build from source</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#documentation">Documentation</a><br>- <a href="hummingboard-iiot-imx8m-plus-som-quick-start-guide.md#related-articles">Related Articles</a></p> |              |                                                                   |
...
![image-20250115-103843.png](../../../../.gitbook/assets/image-20250115-103843.png)

#### Visual features overview

Please see below the features overview of the connector side of the HummingBoard IIOT.

![HummingBoard  i.MX8M IIOT Layout 2024.png](<../../../../.gitbook/assets/HummingBoard  i.MX8M IIOT Layout 2024.png>)

Print side connector overview of the HummingBoard IIOT.

![image-20240929-120103.png](../../../../.gitbook/assets/image-20240929-120103.png)

![image-20241215-110714.png](../../../../.gitbook/assets/image-20241215-110714.png)
...
![image-20241013-104553.png](../../../../.gitbook/assets/image-20241013-104553.png)
...
![image-20240901-112851.png](../../../../.gitbook/assets/image-20240901-112851.png)

Before powering up the board for the first time it is recommended to select the boot media using onboard DIP switch **S5**:

| **Switch**         | <p><strong>1</strong><br>(MD0)</p> | <p><strong>2</strong><br>(MD1)</p> | <p><strong>3</strong><br>(MD2)</p> | <p><strong>4</strong><br>(MD3)</p> | <p><strong>5</strong><br>(VDD_1.8V)</p> | <p><strong>6</strong><br>(VDD_3.3V)</p> |
| ------------------ | ---------------------------------- | ---------------------------------- | ---------------------------------- | ---------------------------------- | --------------------------------------- | --------------------------------------- |
