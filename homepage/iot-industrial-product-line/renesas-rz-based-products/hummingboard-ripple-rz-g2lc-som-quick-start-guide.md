...
> \[!INFO] \[\*] **eMMC Speed Mode:** HighSpeed (up to 52MHz) Supported with RZ/G2LC SOM. For more detailed information about our SOM-RZ/G2LC series please visit this user manual : [RZ/G2LC SOM Hardware User Manual](rz-g2lc-som-hardware-user-manual.md) .
