...
![hb-ripple-rzg2lc.png](./attachments/hb-ripple-rzg2lc.png)
...
| Table of Contents | - [Introduction](https://solidrun.atlassian.net/wiki/spaces/developer/pages/411861047/HummingBoard+Ripple+RZ+G2LC+SOM+Quick+Start+Guide#introduction)<br>- [Revision and Notes](https://solidrun.atlassian.net/wiki/spaces/developer/pages/411861047/HummingBoard+Ripple+RZ+G2LC+SOM+Quick+Start+Guide#revision-and-notes)<br>- [Hardware Setup](https://solidrun.atlassian.net/wiki/spaces/developer/pages/411861047/HummingBoard+Ripple+RZ+G2LC+SOM+Quick+Start+Guide#hardware-setup)<br>  - [Product specifications](https://solidrun.atlassian.net/wiki/spaces/developer/pages/411861047/HummingBoard+Ripple+RZ+G2LC+SOM+Quick+Start+Guide#product-specifications)<br>  - [Block Diagram](https://solidrun.atlassian.net/wiki/spaces/developer/pages/411861047/HummingBoard+Ripple+RZ+G2LC+SOM+Quick+Start+Guide#block-diagram)<br>  - [Visual features overview](https://solidrun.atlassian.net/wiki/spaces/developer/pages/411861047/HummingBoard+Ripple+RZ+G2LC+SOM+Quick+Start+Guide#visual-features-overview)<br>- [Software Setup](https://solidrun.atlassian.net/wiki/spaces/developer/pages/411861047/HummingBoard+Ripple+RZ+G2LC+SOM+Quick+Start+Guide#software-setup)<br>  - [Cable setup and prerequisites](https://solidrun.atlassian.net/wiki/spaces/developer/pages/411861047/HummingBoard+Ripple+RZ+G2LC+SOM+Quick+Start+Guide#cable-setup-and-prerequisites)<br>- [Boot Select](https://solidrun.atlassian.net/wiki/spaces/developer/pages/411861047/HummingBoard+Ripple+RZ+G2LC+SOM+Quick+Start+Guide#boot-select)<br>- [Generating Yocto, Buildroot and Debian image](https://solidrun.atlassian.net/wiki/spaces/developer/pages/411861047/HummingBoard+Ripple+RZ+G2LC+SOM+Quick+Start+Guide#generating-yocto-buildroot-and-debian-image)<br>- [Booting from SD card](https://solidrun.atlassian.net/wiki/spaces/developer/pages/411861047/HummingBoard+Ripple+RZ+G2LC+SOM+Quick+Start+Guide#booting-from-sd-card)<br>  - [More Features](https://solidrun.atlassian.net/wiki/spaces/developer/pages/411861047/HummingBoard+Ripple+RZ+G2LC+SOM+Quick+Start+Guide#more-features)<br>    - [List Of Supported OS](https://solidrun.atlassian.net/wiki/spaces/developer/pages/411861047/HummingBoard+Ripple+RZ+G2LC+SOM+Quick+Start+Guide#list-of-supported-os)<br>- [Build from source](https://solidrun.atlassian.net/wiki/spaces/developer/pages/411861047/HummingBoard+Ripple+RZ+G2LC+SOM+Quick+Start+Guide#build-from-source)<br>- [Documentation](https://solidrun.atlassian.net/wiki/spaces/developer/pages/411861047/HummingBoard+Ripple+RZ+G2LC+SOM+Quick+Start+Guide#documentation)<br>- [Related Articles](https://solidrun.atlassian.net/wiki/spaces/developer/pages/411861047/HummingBoard+Ripple+RZ+G2LC+SOM+Quick+Start+Guide#related-articles) |     |     |
...
| --- | --- |
| I/Os | 2 x USB 2.0<br><br>1 x MIPI-CSI-2 |
| Networking | 1 x Ethernet 100BASE-T<br><br>1 x 802.11 a/b/g/n/ac WiFi and Bluetooth (2.4 GHz) |
| Processor | Renesas RZ/G2UL Single MPcore Arm Cortex A55 up to 1.0GHz + Cortex M33 200MHz |
| Memory & Storage | Up to 2 GB DDR4  <br>8GB eMMC up to 64 GB  <br>MicroSD |
| Display | None |
| Misc. | 1 x Reset button  <br>1 x Configurable button  <br>3 x LED indicators  <br>RTC |
| Development and Debug interfaces | Micro USB |
| Power | 7V – 36V |
| Expansion card I/Os | mikroBUS header  <br>Mini Pcie with SIM holder |
| Temperature | Commercial: 0°C to 70°C  <br>Industrial: -40°C to 85°C |
...
![image-20240205-113315.png](./attachments/image-20240205-113315.png)
...
![image-20240319-091912.png](./attachments/image-20240319-091912.png)

Print side connector overview of the HummingBoard Ripple & RZ/G2UL.

![image-20211104-110340.png](./attachments/image-20211104-110340.png)
...
![image-20221123-220813.png](./attachments/image-20221123-220813.png)
...
5. **Power On**  
Hold on the **On/Off** Power button - **SW1** (as shown in the figure below)![image-20230228-151346.png](./attachments/image-20230228-151346.png)
...
![image-20231127-133436.png](./attachments/image-20231127-133436.png)
...
![image-20231206-093535.png](./attachments/image-20231206-093535.png)

After those steps you should end the process in this way (step 4 to the end):

![image-20231206-094407.png](./attachments/image-20231206-094407.png)
...
| ![](./attachments/image-20211024-151110.png) | [RZ/G2LC Yocto](https://github.com/SolidRun/meta-solidrun-arm-rzg2lc) |
...
|     | File | Modified |
| --- | --- | --- |
| Labels<br><br>- No labels<br>- [Edit Labels](#section