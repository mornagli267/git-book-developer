# HummingBoard Pro & RZ/V2L SOM Quick Start Guide

## Introduction

The following quick start guide provides background information about the [HummingBoard Pro RZ/V2L](https://www.solid-run.com/embedded-industrial-iot/renesas-rz-family/rz-v2l-som/).
...
| 11 Dec 2025       | Yazan Shhady                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | 1.2          | Correct DC input voltage range to 7V–18V       |
| Table of Contents | <p>- <a href="hummingboard-pro-rz-v2l-som-quick-start-guide.md#introduction">Introduction</a><br>- <a href="hummingboard-pro-rz-v2l-som-quick-start-guide.md#revision-and-notes">Revision and Notes</a><br>- <a href="hummingboard-pro-rz-v2l-som-quick-start-guide.md#hardware-setup">Hardware Setup</a><br>- <a href="hummingboard-pro-rz-v2l-som-quick-start-guide.md#product-specifications">Product specifications</a><br>- <a href="hummingboard-pro-rz-v2l-som-quick-start-guide.md#block-diagram">Block Diagram</a><br>- <a href="hummingboard-pro-rz-v2l-som-quick-start-guide.md#visual-features-overview">Visual features overview</a><br>- <a href="hummingboard-pro-rz-v2l-som-quick-start-guide.md#software-setup">Software Setup</a><br>- <a href="hummingboard-pro-rz-v2l-som-quick-start-guide.md#cable-setup-and-prerequisites">Cable setup and prerequisites</a><br>- <a href="hummingboard-pro-rz-v2l-som-quick-start-guide.md#boot-select">Boot Select</a><br>- <a href="hummingboard-pro-rz-v2l-som-quick-start-guide.md#generating-yocto-buildroot-and-debian-image">Generating Yocto, Buildroot and Debian image</a><br>- <a href="hummingboard-pro-rz-v2l-som-quick-start-guide.md#booting-from-sd-card">Booting from SD card</a><br>- <a href="hummingboard-pro-rz-v2l-som-quick-start-guide.md#more-features">More Features</a><br>- <a href="hummingboard-pro-rz-v2l-som-quick-start-guide.md#internet">Internet</a><br>- <a href="hummingboard-pro-rz-v2l-som-quick-start-guide.md#wifi">WiFi</a><br>- <a href="hummingboard-pro-rz-v2l-som-quick-start-guide.md#bluetooth">Bluetooth</a><br>- <a href="hummingboard-pro-rz-v2l-som-quick-start-guide.md#cellular-modem">Cellular Modem</a><br>- <a href="hummingboard-pro-rz-v2l-som-quick-start-guide.md#list-of-supported-os">List Of Supported OS</a><br>- <a href="hummingboard-pro-rz-v2l-som-quick-start-guide.md#build-from-source">Build from source</a><br>- <a href="hummingboard-pro-rz-v2l-som-quick-start-guide.md#documentation">Documentation</a><br>- <a href="hummingboard-pro-rz-v2l-som-quick-start-guide.md#related-articles">Related Articles</a></p> |              |                                                |

## Hardware Setup

#### Product specifications

|                                  | HUMMINGBOARD Pro RZ/V2L                                                                      |
| -------------------------------- | -------------------------------------------------------------------------------------------- |
| I/Os                             | <p>2 x USB 2.0<br>1 x MIPI-CSI<br>1 x Digital audio (Riser interface fpC connector)</p>      |
...
> \[!INFO] Supported with RZ/V2L SOM. For more detailed information about our SOM RZ/V2L series please visit this user manual : [RZ/V2L SOM Hardware User Manual](rz-g2l-and-rz-v2l-som-hardware-user-manual.md) .

#### Block Diagram

The following figure describes the RZ/G2L Block Diagram.

![](../../../.gitbook/assets/image-20230830-165517.png)

#### Visual features overview

Please see below the features overview of the connector side of the HummingBoard Pro & RZ/V2L SOM.

![](<../../../.gitbook/assets/HummingBoard Extended V2L Front layout.png>)

Print side connector overview of the HummingBoard Pro & RZ/V2L SOM.

![](<../../../.gitbook/assets/HummingBoard Extended RZ_V2L layout.png>)
...
* Linux or Windows PC
* HummingBoard Pro with RZ/G2L SOM (HummingBoard Pro & RZ/V2L SOM)
...
Before powering up the board for the first time it is recommended to select the boot media. In order to configure the boot media, please refer to [HummingBoard RZ/V2L Boot Select](rz-g2-other-articles/hummingboard-rz-g2lc-g2ul-g2l-v2l-boot-select.md) .
...
```
https://solid-run-images.sos-de-fra-1.exo.io/RZ/Debian/build_date_20240529-git_rev_f22483f/rzv2l-solidrun-sd-debian-f22483f.img.xz
```

* For more Debian releases, please visit [Debian Releases for RZ/V2L](https://images.solid-run.com/RZ/rzg2lc_build).
