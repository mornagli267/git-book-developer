...
> \[!NOTE] SD boot (Dip-Switch) \[**S3** = {1:off, 2:off, 3:off,4-5: N/C, 6:on}] eMMC boot (Dip-Switch) \[**S3** = {1:off, 2:on, 3:off,4-5: N/C, 6:off}] Serial Downloader (Dip-Switch) \[**S3** = {1:off, 2:on, 3:on,4-5: N/C, 6:off}]

## When using HummingBoard Pro & RZ/G2LC or RZ/G2UL SOM

![](../../../../.gitbook/assets/g2lc-extended-20231009-131637.png)

> \[!NOTE] SD boot (Dip-Switch) \[**S3** = {1:off, 2:off, 3:off, 4:on, 5-6: N/C}] eMMC boot (Dip-Switch) \[**S3** = {1:off, 2:on, 3:off, 4: off, 5-6: N/C}] Serial Downloader (Dip-Switch) \[**S3** = {1:off, 2:on, 3:on, 4: off, 5-6: N/C}]

## When using HummingBoard Ripple & RZ/G2L or RZ/V2L SOM

![](../../../../.gitbook/assets/g2l-ripple-20231009-133524.png)

> \[!NOTE] SD boot (Dip-Switch) \[**S3** = {1-3: off, 4-5: N/C, 6: off}] eMMC boot (Dip-Switch) \[**S3** = {1:off, 2:on, 3:off, 4-5: N/C, 6:on}] Serial Downloader (Dip-Switch) \[**S3** = {1:off, 2:on, 3:on, 4-5: N/C, 6:on}]

## When using HummingBoard Pro & RZ/G2L or RZ/V2L SOM

![](../../../../.gitbook/assets/g2l-extended-20231009-134134.png)

> \[!NOTE] SD boot (Dip-Switch) \[**S3** = {1:off, 2:off, 3:off, 4:off, 5-6: N/C}] eMMC boot (Dip-Switch) \[**S3** = {1:off, 2:on, 3:off, 4: on, 5-6: N/C}] Serial Downloader (Dip-Switch) \[**S3** = {1:off, 2-4: on, 5-6: N/C}]
