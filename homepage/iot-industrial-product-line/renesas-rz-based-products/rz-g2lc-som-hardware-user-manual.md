...
| 17 Jan 2024 | Yazan Shhady | 1.3 | Add SOM Rev 1.2 changes:<br><br>- Moving RZ\_P39\_2 from J7\[28\] to J7\[18\] to support USB\_PWR\_EN on HBP<br><br>- Change the voltage level of the MD0-MD2 from 1V8 to 3V3 |
| 18 Nov 2024 | Yazan Shhady | 1.4 | Updated the documentation to reflect the eMMC speed mode as **HighSpeed** |
| Table of Contents | - [Revisions and Notes](#revisions-and-notes)<br>- [Introduction](#introduction)<br>- [Overview](#overview)<br>  - [Highlighted Features](#highlighted-features)<br>  - [Supporting Products](#supporting-products)<br>- [Description](#description)<br>  - [Block Diagram](#block-diagram)<br>  - [Features Summary](#features-summary)<br>- [Core System Components](#core-system-components)<br>  - [RZ/G2LC SoC](#rz-g2lc-soc)<br>  - [MEMORIES](#memories)<br>  - [DDR4](#ddr4)<br>  - [eMMC and SD NAND Memory](#emmc-and-sd-nand-memory)<br>  - [Micro-SD (Carrier)](#micro-sd-carrier)<br>  - [Quad Serial NOR Flash (SOM)](#quad-serial-nor-flash-som)<br>  - [EEPROM (SOM)](#eeprom-som)<br>  - [Serial NOR Flash (Carrier)](#serial-nor-flash-carrier)<br>  - [10/100 Mbps Ethernet PHY](#10-100-mbps-ethernet-phy)<br>  - [WI-FI (802.11A/B/G/N) AND BT 5.2 (MURATA'S CERTIFIED MODULE)](#wi-fi-80211a-b-g-n-and-bt-52-muratas-certified-module)<br>  - [WI-FI & BT](#wi-fi-bt)<br>- [External Interfaces](#external-interfaces)<br>  - [General](#general)<br>  - [USB-2.0](#usb-20)<br>  - [MIPI CSI](#mipi-csi)<br>  - [MIPI DSI](#mipi-dsi)<br>  - [Audio](#audio)<br>  - [UART](#uart)<br>  - [SPI](#spi)<br>  - [I2C](#i2c)<br>  - [uSD](#usd)<br>  - [CAN-FD](#can-fd)<br>- [CONNECTOR’S SIGNAL DESCRIPTION](#connectors-signal-description)<br>  - [J5001](#j5001)<br>  - [J7](#j7)<br>  - [J9](#j9)<br>  - [SOM Revision and Notes](#som-revision-and-notes)<br>  - [mikroBUS](#mikrobus)<br>- [Power & Reset](#power-reset)<br>  - [Power Consumption](#power-consumption)<br>  - [RESET](#reset)<br>- [RZG2LC/UL INTEGRATION MANUAL](#rzg2lc-ul-integration-manual)<br>  - [POWER UP SEQUENCE](#power-up-sequence)<br>  - [BOOTING OPTIONS](#booting-options)<br>    - [Strap pins Booting](#strap-pins-booting)<br>  - [I2C INTERFACES](#i2c-interfaces)<br>  - [GPIO INTERFACES](#gpio-interfaces)<br>- [Mechanical Description](#mechanical-description)<br>- [Documentation](#documentation)<br>- [Related Articles](#related-articles) |     |     |
...
- [HummingBoard Ripple](../renesas-rz-based-products/hummingboard-ripple-rz-g2lc-som-quick-start-guide.md) – A board computer that incorporates the SOM retains the same Android and different Linux distributions while adding extra hardware functionalities and access to the hardware.
...
![](./attachments/RZ_G2LC-SOM-block-diagram-2023-1030x780.png)
...
<a id="wi-fi-80211a-b-g-n-and-bt-52-muratas-certified-module"></a>

#### WI-FI (802.11A/B/G/N) AND BT 5.2 (MURATA'S CERTIFIED MODULE)

![](./attachments/image-20221212-074105.png)
...
![](./attachments/image-20221212-074206.png)
...
![](./attachments/image-20221215-091513.png)
...
![](./attachments/image-20221215-091522.png)
...
![](./attachments/image-20221212-074403.png)
...
![](./attachments/image-20221212-074451.png)
...
![](./attachments/image-20221212-074547.png)
...
![](./attachments/image-20221212-074623.png)
...
![](./attachments/image-20221212-074822.png)
...
<a id="som-revision-and-notes"></a>

#### SOM Revision and Notes

![image-20240117-150854.png](./attachments/image-20240117-150854.png)
...
| Linux up, scanning for bluetooth<br><br>device | 5V  | 295mA | 1.475W |
| Linux up, GPU stress by glmark2 | 5V  | 514mA | 2.57W |
| Linux up, CPU stress to maximum | 5V  | 437mA | 2.185W |
| All utilities are active in the same<br><br>time (Wifi, GPU stress, CPU<br><br>stress, Bluetooth) | 5V  | 700mA | 3.5W |
...
<a id="rzg2lc-ul-integration-manual"></a>
...
![](./attachments/image-20221215-091358.png)
...
![](./attachments/image-20221212-075459.png)

[RZ_G2LC-UL-SOM_BoardAndModels-step-file.zip](./attachments/RZ_G2LC-UL-SOM_BoardAndModels-step-file.zip)
...
|     | File | Modified |
| --- | --- | --- |
| Labels<br><br>- No labels<br>- [Edit Labels](#section-66c24648-a700-4676-92b6-be5effa2303d)<br><br>[Preview] [View](/wiki/download/attachments/411861054/RZ_G2LC-UL-SOM_BoardAndModels-step-file.zip?version=1) [Properties](/wiki/pages/editattachment.action?pageId=411861054&fileName=RZ_G2LC-UL-SOM_BoardAndModels-step-file.zip&isFromPageView=true) [Delete](/wiki/pages/confirmattachmentremoval.action?pageId=411861054&fileName=RZ_G2LC-UL-SOM_BoardAndModels-step-file.zip) | ZIP Archive [RZ\_G2LC-UL-SOM\_BoardAndModels-step-file.zip](/wiki/download/attachments/411861054/RZ_G2LC-UL-SOM_BoardAndModels-step-file.zip?api=v2) | May 15, 2023 by [Yazan Shhady](/wiki/people/5f67bce9ed55c7006abc6319) |
| Labels<br><br>- No labels<br>- [Edit Labels](#section-2c0cf0d0-a610-4e80-ba17-e68f5f9baf24)<br><br>[Preview] [View](/wiki/download/attachments/411861054/rzg2lc-som-1.2-simplified.pdf?version=1) [Properties](/wiki/pages/editattachment.action?pageId=411861054&fileName=rzg2lc-som-1.2-simplified.pdf&isFromPageView=true) [Delete](/wiki/pages/confirmattachmentremoval.action?pageId=411861054&fileName=rzg2lc-som-1.2-simplified.pdf) | PDF File [rzg2lc-som-1.2-simplified.pdf](/wiki/download/attachments/411861054/rzg2lc-som-1.2-simplified.pdf?api=v2) | Jan 24, 2024 by [Yazan Shhady](/wiki/people/5f67bce9ed55c7006abc6319) |
...
[Download All](/wiki/download/all_attachments?pageId=411861054)
