...
| Table of Contents | - [Revision and Notes](#revision-and-notes)<br>- [Introduction](#introduction)<br>  - [Overview](#overview)<br>  - [Highlighted Features](#highlighted-features)<br>  - [Supporting Products](#supporting-products)<br>  - [Summary of Features](#summary-of-features)<br>- [Block Diagram](#block-diagram)<br>- [Core System Components](#core-system-components)<br>  - [i.MX6 SOC Family](#imx6-soc-family)<br>  - [10/100/1000 MBPS Ethernet PHY](#10-100-1000-mbps-ethernet-phy)<br>  - [BCM 4330 Based (SOM Rev 1.3) – Wireless LAN 802.11 B/G/N & Bluetooth 4.0 SiP](#bcm-4330-based-som-rev-13-wireless-lan-80211-b-g-n-bluetooth-40-sip)<br>  - [TI WiLink8 Based(SOM Rev 1.5) – Wireless LAN 802.11 B/G/N & Bluetooth 4.1 SiP](#ti-wilink8-basedsom-rev-15-wireless-lan-80211-b-g-n-bluetooth-41-sip)<br>- [i.MX6 SOM Interfaces](#imx6-som-interfaces)<br>  - [i.MX6 SOM- External Interfaces Brief](#imx6-som-external-interfaces-brief)<br>- [SR-SOM-MX6 ON Board Functions](#sr-som-mx6-on-board-functions)<br>  - [10/100/1000 Mbps PHY](#10-100-1000-mbps-phy)<br>  - [802.11 b/g/n and Bluetooth SiP](#80211-b-g-n-and-bluetooth-sip)<br>- [i.MX6 SOM External Interfaces Detailed Description](#imx6-som-external-interfaces-detailed-description)<br>  - [J5002 Board to Board Header Pin Description](#j5002-board-to-board-header-pin-description)<br>  - [J8004 Board to Board Header Pin Description](#j8004-board-to-board-header-pin-description)<br>  - [J5001 Board to Board Header Pin Description](#j5001-board-to-board-header-pin-description)<br>  - [i.MX6 SOM Power Up Sequence](#imx6-som-power-up-sequence)<br>- [i.MX6 SOM GPIO (Internal) Boot Source Configuration](#imx6-som-gpio-internal-boot-source-configuration)<br>  - [Boot from SDHC2 External SD Card](#boot-from-sdhc2-external-sd-card)<br>  - [Boot from SDHC3 eMMC](#boot-from-sdhc3-emmc)<br>  - [Boot from SATA](#boot-from-sata)<br>  - [Rev 1.3 Debugging Capability](#rev-13-debugging-capability)<br>  - [Rev 1.5 Debugging Capability](#rev-15-debugging-capability)<br>  - [Differences Between SOM Versions](#differences-between-som-versions)<br>    - [Changes Between SOM Rev 1.0 to Rev 1.2](#changes-between-som-rev-10-to-rev-12)<br>    - [Changes Between SOM Rev 1.2 to Rev 1.3](#changes-between-som-rev-12-to-rev-13)<br>    - [Changes Between SOM Rev 1.3 to Rev 1.5](#changes-between-som-rev-13-to-rev-15)<br>  - [Typical Power Consumption](#typical-power-consumption)<br>  - [imx6 SOM Power Consumption](#imx6-som-power-consumption)<br>  - [Maximum Rating](#maximum-rating)<br>- [Mechanical Description](#mechanical-description)<br>- [Documentation](#documentation)<br>- [Related Articles](#related-articles) |     |     |
...
![](./attachments/i.MX6%20SOM%20rev%201.5%20block%20diagram%202021.jpg)

<a id="core-system-components"></a>

## Core System Components

<a id="imx6-soc-family"></a>
...
<a id="bcm-4330-based-som-rev-13-wireless-lan-80211-b-g-n-bluetooth-40-sip"></a>
...
<a id="ti-wilink8-basedsom-rev-15-wireless-lan-80211-b-g-n-bluetooth-41-sip"></a>
...
<a id="imx6-som-interfaces"></a>

## i.MX6 SOM Interfaces

<a id="imx6-som-external-interfaces-brief"></a>
...
<a id="sr-som-mx6-on-board-functions"></a>

## SR-SOM-MX6 ON Board Functions

<a id="10-100-1000-mbps-phy"></a>
...
<a id="80211-b-g-n-and-bluetooth-sip"></a>
...
<a id="imx6-som-external-interfaces-detailed-description"></a>
...
<a id="j5002-board-to-board-header-pin-description"></a>
...
| BOOT\_CFG2\[1\] | M21 | EIM\_DA9 | i.MX6 | DISP1\_DATA00 | 66  | 65  | NVCC\_EIM0 | Many |     |     | Although called NVCC\_EIM0, this power rail supplies the i.MX6, Ethernet phy, WiFi / BT and others.  <br> Refer to the public schematics for more details. |
...
<a id="j8004-board-to-board-header-pin-description"></a>
...
<a id="j5001-board-to-board-header-pin-description"></a>
...
<a id="imx6-som-power-up-sequence"></a>
...
<a id="imx6-som-gpio-internal-boot-source-configuration"></a>
...
Blowing the device’s eFuses is alternative to using GPIOs in order to set boot source. This topic is widely covered on the SolidRun [eFuses for i.MX6 SOM (Developers page)](../nxp-imx6-based-products/imx6-other-articles/efuses-for-imx6-som-developers-page.md) .
...
Since the above forces the user to pull up/down the entire bus, below are more pervasive examples of 3 different boot sources used as in [HummingBoard Edge Quick Start Guide](../nxp-imx6-based-products/hummingboard-imx6-sbc-quick-start-guide/hummingboard-edge-quick-start-guide.md) :

- SDHC2 SD
- SDHC3 eMMC
- SATA

<a id="boot-from-sdhc2-external-sd-card"></a>
...
| BOOT\_CFG2\[4\] | EIM\_DA11 | DI1\_PIN03 | Can be either 0 or 1 (TX<br><br>spread spectrum) |
| BOOT\_CFG3\[6\] | EIM\_A22 | DISP1\_DATA17 | Must be 0 |
| BOOT\_CFG3\[7\] | EIM\_A23 | DISP1\_DATA18 | Must be 0 |
| BOOT\_CFG3\[2\] | EIM\_A18 | DISP1\_DATA13 | Boot freq – preferred 0 |
| BOOT\_CFG4\[7\] | EIM\_EB3 | EIM\_EB3 | Must be 0 |
...
<a id="rev-13-debugging-capability"></a>
...
![](./attachments/image-20211226-093141.png)

<a id="rev-15-debugging-capability"></a>
...
<a id="typical-power-consumption"></a>
...
| Android idle | 240mA | Performance governor, HDMI is on,<br><br>USB, eSata, WiFi and Ethernet are off |
| Android idle with Ethernet | 340mA | Performance governor, HDMI is on, USB, eSata, WiFi and Ethernet is<br><br>1Gbps (note #1) |
...
| Linux idle | 170mA | Performance governor, HDMI, USB,<br><br>eSata, WiFi and Ethernet are all off. |
...
<a id="imx6-som-power-consumption"></a>
...
| Supplies i.MX6 (GPIO, Parallel display interface etc…), AR8030/AR8035 Ethernet phy, part of the AzureWave SiP | NVCC\_EIM0 | –   | 300 (2)<br><br>(5) | mA  |
| SD2 I/O | NVCC\_SD2 | –   | 22 (3) | mA  |
| SD3 I/O | NVCC\_SD3 | –   | 40 (3) | mA  |
| Supplies all SR-SOM-MX6 power management devices. | VIN\_5V0 | –   | 1500 (4)<br><br>(5) | mA  |
...
![](./attachments/image-20211226-093334.png)
...
|     | File | Modified |
| --- | --- | --- |
| Labels<br><br>- No labels<br>- [Edit Labels](#section-2711e47a-2dee-426d-9f5b-1de8212e1982)<br><br>[Preview] [View](/wiki/download/attachments/197493466/iMX6+SOM+Heatsink.zip?version=1) [Properties](/wiki/pages/editattachment.action?pageId=197493466&fileName=iMX6+SOM+Heatsink.zip&isFromPageView=true) [Delete](/wiki/pages/confirmattachmentremoval.action?pageId=197493466&fileName=iMX6+SOM+Heatsink.zip) | ZIP Archive [iMX6 SOM Heatsink.zip](/wiki/download/attachments/197493466/iMX6%20SOM%20Heatsink.zip?api=v2) | Dec 26, 2021 by [SolidRun](/wiki/people/557058:12be2ae4-3a6e-40cc-a677-bdfc4c987d1f) |
| Labels<br><br>- No labels<br>- [Edit Labels](#section