...
you can follow the [i.MX6 U-Boot](../../nxp-imx6-based-products/imx6-software/imx6-u-boot.md) guide to generate a new U-Boot for imx6 SOM.
...
[u-boot.img](./attachments/u-boot.img)
[SPL](./attachments/SPL)
[0001-add-imx6dl_2g_mmcd_calib.patch](./attachments/0001-add-imx6dl_2g_mmcd_calib.patch)