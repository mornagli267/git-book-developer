...
* Set the boot select jumpers to boot from SDHC, please see [HummingBoard Edge/Gate Boot Jumpers](hummingboard-edge-gate-boot-jumpers.md) article for more information.
* Boot from SDHC
