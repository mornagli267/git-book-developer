...
|     |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- |
| **Grade** | **SolidRun SKU** | **i.MX6 CPU** | **DDR3** | **Ethernet**<br><br>**PHY** | **Crystal** | **PWR Mngmnt** | **WiFi (\*)** |
...
> [!INFO]
> **Please note**
> By default the i.MX6 Dual and Quad core CPU are “commercial extended” by default
> (\*) For WiFi there is an industrial ordering option – Please contact SolidRun for additional information
...
![](./attachments/image-20211104-093559.png)

NXP i.MX6 Order-able CPUs options (Dual and Quad):

  

![](./attachments/image-20211104-093616.png)

<a id="hummingboard-base-pro"></a>
...
> [!WARNING]
> **Comments**
> The temperatures of the components are Operating Ta (ambient):
> Commercial: 0C-70C
> Industrial: -40C-85C
