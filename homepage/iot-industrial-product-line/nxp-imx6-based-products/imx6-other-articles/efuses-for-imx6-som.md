...
> [!WARNING]
> **An updated version of this article can be found here:** [**Setting the eFuses (developers)**](../imx6-other-articles/efuses-for-imx6-som-developers-page.md) **.**

<a id="setting-the-efuses-for-microsom-and-hummingboard"></a>
...
<a id="usb-host-to-host-cable-preparation"></a>
...
<a id="run-mfgtool-to-blow-the-efuses"></a>
...
<a id="understanding-the-efuse-settings"></a>
...
<a id="booting-from-other-sources"></a>
...
![](./attachments/image-20211226-130441.png)
