...
> \[!NOTE] **Please note** The prebuilt images are configured for SO-DIMM DDR4 with speed of 3200, 2900, 2600 and 2400 Mtps (with or without ECC support),. Images that have the prefix lx2160a\_xspi are intended to be flashed into SPI and recommended for later use after being booted from micro SD
...
> \[!WARNING] For this to work eMMC distroboot support is required (patch is here – [LSDK-19.09 u-boot support · SolidRun/lx2160a\_build@75891e5](https://github.com/SolidRun/lx2160a_build/commit/75891e5cb4d2171a2094c1e35087374b1f47acdd)  )
...
> \[!WARNING] **Please Note:** The above commands should be run only once (in the fist boot).
