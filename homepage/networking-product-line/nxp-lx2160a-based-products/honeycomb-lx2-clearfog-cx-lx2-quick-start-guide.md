...
![](./attachments/image-20220112-163008.png)
...
| --- | --- | --- | --- |
| 28 Oct 2021 |     | 1.0 |     |
| Table of Contents | - [Introduction](#introduction)<br>- [Revision and Notes](#revision-and-notes)<br>- [Hardware Setup](#hardware-setup)<br>  - [Product Specifications](#product-specifications)<br>- [Block Diagram](#block-diagram)<br>- [Visual features overview](#visual-features-overview)<br>- [Software Setup](#software-setup)<br>  - [Cable setup and prerequisites](#cable-setup-and-prerequisites)<br>- [Recommended Cables](#recommended-cables)<br>- [Boot Select](#boot-select)<br>- [Booting from an SD card](#booting-from-an-sd-card)<br>- [SFP Modules](#sfp-modules)<br>- [Using the built-in NICs](#using-the-built-in-nics)<br>- [Packet Generator using DPDK](#packet-generator-using-dpdk)<br>- [GPUs](#gpus)<br>- [Tips](#tips)<br>- [Example to install Gentoo from the Ubuntu](#example-to-install-gentoo-from-the-ubuntu)<br>- [Build From Source](#build-from-source)<br>- [Documentation](#documentation)<br>- [Related Articles](#related-articles) |     |     |
...
| --- | --- | --- |
| I/Os | 3 x USB 3.0  <br>3 x USB 2.0 | 3 x USB 3.0  <br>3 x USB 2.0 |
| Networking | 1 x QSFP port 100GbE  <br>4 x SFP+ ports (10GbE each)  <br>1 x 1GbE copper (RJ45) | 4 x SFP+ ports (10GbE each)  <br>1 x 1GbE copper (RJ45) |
...
| Memory & Storage | Up to 64GB DDR4 DIMM  <br>64GB eMMC  <br>MicroSD  <br>4 x SATA 3.0 | Up to 64GB DDR4 DIMM  <br>64GB eMMC  <br>MicroSD  <br>4 x SATA 3.0 |
| Misc. | USB to STM32 for remote management | USB to STM32 for remote management |
| Development and Debug interfaces | Micro USB  <br>JTAG | Micro USB  <br>JTAG |
| Power | ATX standard | ATX standard |
| Expansion card I/Os | 1 x PCIe x8 Gen 3.0, open slot (can support x16)  <br>1 x M.2 | 1 x PCIe x8 Gen 3.0, open slot (can support x16)  <br>1 x M.2 |
| Temperature | Commercial: 0°C to 70°C | Commercial: 0°C to 70°C |
| Dimensions | PCBA: 170 x 170mm | PCBA: 170 x 170mm |

![](./attachments/image-20220112-162314.png)

![](./attachments/image-20220112-162250.png)

> [!NOTE]
> - See list of tested [LX2160A COM Tested SO-DIMM Memory](../nxp-lx2160a-based-products/lx2160a-other-articles/lx2160a-com-tested-so-dimm-memory.md) modules.
...
![](./attachments/image-20220112-163102.png)
...
![](./attachments/image-20220112-163245.png)
...
> [!NOTE]
> **Please note**
> The prebuilt images are configured for SO-DIMM DDR4 with speed of 2900, 2600 and 2400 Mtps (with or without ECC support),. Images that have the infix `_xspi_` are intended to be flashed into SPI and recommended for later use after booting another image from micro SD
...
<a id="using-the-built-in-nics"></a>
...
|     | File | Modified |
| --- | --- | --- |
| Labels<br><br>- No labels<br>- [Edit Labels](#section-947c9c7b-e005-4ae1-9e8f-38ba9ce69108)<br><br>[Preview] [View](/wiki/download/attachments/197494288/ClearFog-CX-and-HoneyComb-Schematics-and-Layout-4977.zip?version=1) [Properties](/wiki/pages/editattachment.action?pageId=197494288&fileName=ClearFog-CX-and-HoneyComb-Schematics-and-Layout-4977.zip&isFromPageView=true) [Delete](/wiki/pages/confirmattachmentremoval.action?pageId=197494288&fileName=ClearFog-CX-and-HoneyComb-Schematics-and-Layout-4977.zip) | ZIP Archive [ClearFog-CX-and-HoneyComb-Schematics-and-Layout-4977.zip](/wiki/download/attachments/197494288/ClearFog-CX-and-HoneyComb-Schematics-and-Layout-4977.zip?api=v2) | Dec 26, 2021 by [SolidRun](/wiki/people/557058:12be2ae4-3a6e-40cc-a677-bdfc4c987d1f) |
| Labels<br><br>- No labels<br>- [Edit Labels](#section-c434a72c-fcc8-4f5f-81ab-19d6d10a9a3e)<br><br>[Preview] [View](/wiki/download/attachments/197494288/ClearFog+CX+LX2%2C+HoneyComb+LX2+Mechanical.zip?version=1) [Properties](/wiki/pages/editattachment.action?pageId=197494288&fileName=ClearFog+CX+LX2%2C+HoneyComb+LX2+Mechanical.zip&isFromPageView=true) [Delete](/wiki/pages/confirmattachmentremoval.action?pageId=197494288&fileName=ClearFog+CX+LX2%2C+HoneyComb+LX2+Mechanical.zip) | ZIP Archive [ClearFog CX LX2, HoneyComb LX2 Mechanical.zip](/wiki/download/attachments/197494288/ClearFog%20CX%20LX2,%20HoneyComb%20LX2%20Mechanical.zip?api=v2) | Dec 26, 2021 by [SolidRun](/wiki/people/557058:12be2ae4-3a6e-40cc-a677-bdfc4c987d1f) |

[Download All](/wiki/download/all_attachments?pageId=197494288)
