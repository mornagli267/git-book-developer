...
| --- | --- | --- | --- |
| 26 Sep 2021 | Alon Rotman | 1.0 | Initial release<br><br>information 2. Relevant for PCB revision 1.0 |
...
| Table of Contents | - [Revision and Notes](#revision-and-notes)<br>- [Introduction](#introduction)<br>  - [Overview](#overview)<br>  - [Block Diagram](#block-diagram)<br>  - [Specifications](#specifications)<br>  - [Compatibility between SOMs A388 and CN9130](#compatibility-between-soms-a388-and-cn9130)<br>  - [Power Consumption](#power-consumption)<br>  - [Frequency Scaling](#frequency-scaling)<br>  - [Power Measurments](#power-measurments)<br>- [CN9130 SOM extensions](#cn9130-som-extensions)<br>  - [SERDES Muxing CN9130 – CP0:](#serdes-muxing-cn9130-cp0)<br>  - [CORE Clock BOOT Straps](#core-clock-boot-straps)<br>  - [BOOT MODE BOOT Straps](#boot-mode-boot-straps)<br>  - [CP0 MPP\[62:0\]](#cp0-mpp620)<br>- [SOM Header Details](#som-header-details)<br>  - [Connector J1](#connector-j1)<br>  - [Connector J2](#connector-j2)<br>  - [Connector J3](#connector-j3)<br>- [Heatsink](#heatsink)<br>- [Precision Time Protocol (PTP)](#precision-time-protocol-ptp)<br>  - [Enable PTP on Clearfog Base / Pro](#enable-ptp-on-clearfog-base-pro)<br>- [Documentation](#documentation) |     |     |
...
![](./attachments/CN9130%20SOM%20block%20diagram.png)
...
| Processor speed | 2.2GHz (Commercial)  <br>2GHz (Industrial) |
| DDR | On board DDR4:  <br>Up to 16GB @ 2400MT/s  <br>64bit (+ optional 8bit of ECC) |
| eMMC | Up to 64GB (assembled 8GB) |
| Flash | 64Mbit SPI NOR flash |
| SATA 3.0 | up to 2 Ports |
| Ethernet | 1x MDI using 88E1512 PHY<br><br>1x 10/5 GbE port + 2x 1/2.5 GbE Ports  <br>or  <br>2x 5 GbE Port +1x 1/2.5 GbE Port |
| PCIe gen 3.0 | 1 Port x4 + 2 Ports x 1  <br>Total of 3 controllers and up to 6 lanes |
...
| SPI bus | ✓   |
| RTC support | ✓   |
| Power | 5V to 12V DC-input  <br>11.3W full system |
...
<a id="compatibility-between-soms-a388-and-cn9130"></a>
...
| Idle u-boot | 4.6 | 50  |
| idle Linux | 4.08  <br>4.2  <br>4.7  <br>5 | 53  <br>65  <br>90  <br>105 |
| memtester 64bit 2400MT/s | 9.25  <br>10.1  <br>11.3 | 70  <br>85  <br>105 |
| cpuburn-karit 4 cores at 2.2GHz | 9.3  <br>9.86  <br>10.8 | 70  <br>90  <br>105 |

<a id="cn9130-som-extensions"></a>
...
<a id="serdes-muxing-cn9130-cp0"></a>
...
| AP\_MPP\[11\] | AY18 | AP\_UA0\_TXD | PD - Reset strap  <br>3.3V thorough FXL2TD245L10X level shifter |
...
| MPP\[15\] | AT32 | CP\_SPI1\_MOSI | 3.3V, CPU Subsystem Clock  <br>CP0\_SYS\_PLL\_SEL0 |
| MPP\[16\] | AV34 | CP\_SPI1\_SCK | 3.3V, CPU Subsystem Clock  <br>CP0\_SYS\_PLL\_SEL1 |
| MPP\[17\] | BA29 | CP\_GPIO\[17\] | 3.3V, PD 50k, CPU Subsystem Clock  <br>CP0\_SYS\_PLL\_SEL2 |
...
| MPP\[24\] | AP34 | NC  |     |
| MPP\[25\] | AT34 | CP\_GPIO\[25\] | 3.3V, Reset strap  <br>2.2K PD |
| MPP\[26\] | AT38 | CP\_GPIO\[26\] | 3.3V, Reset strap  <br>10K PU |
...
| MPP\[37\] | F34 | CP\_I2C0\_SCK | 3.3V, 2.2K PU  <br>EEPROM 0x53 |
| MPP\[38\] | H34 | CP\_I2C0\_SDA | 3.3V, 2.2K PU  <br>EEPROM 0x53 |
...
| MPP\[46\] | C37 | CP\_GE2\_TXD\[1\] | 1.8V, CPU Subsystem Clock  <br>CP0\_SYS\_PLL\_SEL3, 10K PD |
...
| SD CARD, 3.3V, 2.2K PU | CP\_MPP\[43\] | SD\_CP0\_CD\_N | 36  | 35  | SMI\_CP0\_MDIO | CP\_MPP\[0\] | 1.8V, 2.2K PU,  <br>connected to PHY 88E1512 ADD 0x0 |
| 3.3V thorough NTB0102GD level shifter, 2.2K PU | AP\_MPP\[19\] | UART\_AP\_RX0 | 38  | 37  | SMI\_CP0\_MDC | CP\_MPP\[1\] | 1.8V, 2.2K PD (Reset Strap),  <br>connected to PHY 88E1512 ADD 0x0 |
| 3.3V thorough NTB0102GD level shifter, 2.2K PU | AP\_MPP\[11\] | UART\_AP\_TX0 | 40  | 39  | POWER\_OFF\_N |     | 1.8V |
| Reset IN  <br>3.3V, 2.2K PU |     | SYS\_RESET\_N | 42  | 41  | GND (FIXED) |     |     |
|     |     |     | 44  | 43  | JTAG\_CP0\_TCK |     | JTAG, 3.3V, 10K PD |
| Reset OUT  <br>3.3V, 2.2K PU |     | CP0\_SYSRST\_OUT\_N | 46  | 45  | JTAG\_CP0\_TRST\_N |     | JTAG, 3.3V, 10K PD |
...
|     |     |     | 64  | 63  |     |     |     |
| 3.3V, 2.2K PU,  <br>EEPROM 0x53 | CP\_MPP\[38\] | I2C0\_CP0\_SDA | 66  | 65  |     |     |     |
| 3.3V, 2.2K PU,  <br>EEPROM 0x53 | CP\_MPP\[37\] | I2C0\_CP0\_SCL | 68  | 67  |     |     |     |
...
<a id="precision-time-protocol-ptp"></a>
...
<a id="enable-ptp-on-clearfog-base-pro"></a>
...
|     | File | Modified |
| --- | --- | --- |
| Labels<br><br>- No labels<br>- [Edit Labels](#section-12a73a8b-9f03-4869-aff2-4abaa6bd5374)<br><br>[Preview] [View](/wiki/download/attachments/197493875/cn9130_som_rev1.1-simplified+schematics.pdf?version=1) [Properties](/wiki/pages/editattachment.action?pageId=197493875&fileName=cn9130_som_rev1.1-simplified+schematics.pdf&isFromPageView=true) [Delete](/wiki/pages/confirmattachmentremoval.action?pageId=197493875&fileName=cn9130_som_rev1.1-simplified+schematics.pdf) | PDF File [cn9130\_som\_rev1.1-simplified schematics.pdf](/wiki/download/attachments/197493875/cn9130_som_rev1.1-simplified%20schematics.pdf?api=v2) | Nov 07, 2021 by [SolidRun](/wiki/people/557058:12be2ae4-3a6e-40cc-a677-bdfc4c987d1f) |
| Labels<br><br>- No labels<br>- [Edit Labels](#section-103595da-c1a5-4726-9a78-a4b51aa012e0)<br><br>[Preview] [View](/wiki/download/attachments/197493875/CN9130-som-heatsink-files.zip?version=1) [Properties](/wiki/pages/editattachment.action?pageId=197493875&fileName=CN9130-som-heatsink-files.zip&isFromPageView=true) [Delete](/wiki/pages/confirmattachmentremoval.action?pageId=197493875&fileName=CN9130-som-heatsink-files.zip) | ZIP Archive [CN9130-som-heatsink-files.zip](/wiki/download/attachments/197493875/CN9130-som-heatsink-files.zip?api=v2) | Dec 26, 2021 by [SolidRun](/wiki/people/557058:12be2ae4-3a6e-40cc-a677-bdfc4c987d1f) |
| Labels<br><br>- No labels<br>- [Edit Labels](#section-5ffa3854-8d74-4418-b7e1-2cdc454645c3)<br><br>[Preview] [View](/wiki/download/attachments/197493875/B2B+pinout+A388+and+CN9130.xlsx?version=1) [Properties](/wiki/pages/editattachment.action?pageId=197493875&fileName=B2B+pinout+A388+and+CN9130.xlsx&isFromPageView=true) [Delete](/wiki/pages/confirmattachmentremoval.action?pageId=197493875&fileName=B2B+pinout+A388+and+CN9130.xlsx) | Microsoft Excel Spreadsheet [B2B pinout A388 and CN9130.xlsx](/wiki/download/attachments/197493875/B2B%20pinout%20A388%20and%20CN9130.xlsx?api=v2) | Dec 26, 2021 by [SolidRun](/wiki/people/557058:12be2ae4-3a6e-40cc-a677-bdfc4c987d1f) |
| Labels<br><br>- No labels<br>- [Edit Labels](#section-3010ed0e-86d6-4838-86eb-3092bfa7688d)<br><br>[Preview] [View](/wiki/download/attachments/197493875/CN9130-SOM-Mechanical-Files.zip?version=2) [Properties](/wiki/pages/editattachment.action?pageId=197493875&fileName=CN9130-SOM-Mechanical-Files.zip&isFromPageView=true) [Delete](/wiki/pages/confirmattachmentremoval.action?pageId=197493875&fileName=CN9130-SOM-Mechanical-Files.zip) | ZIP Archive [CN9130-SOM-Mechanical-Files.zip](/wiki/download/attachments/197493875/CN9130-SOM-Mechanical-Files.zip?api=v2) Change: CPU height 2.2mm --> 1.8mm | Dec 29, 2021 by [SolidRun](/wiki/people/557058:12be2ae4-3a6e-40cc-a677-bdfc4c987d1f) |
| Labels<br><br>- No labels<br>- [Edit Labels](#section-632e333d-e54c-4737-8548-4a585f879021)<br><br>[Preview] [View](/wiki/download/attachments/197493875/CN9130_SOM_REV1.1_STEP.zip?version=1) [Properties](/wiki/pages/editattachment.action?pageId=197493875&fileName=CN9130_SOM_REV1.1_STEP.zip&isFromPageView=true) [Delete](/wiki/pages/confirmattachmentremoval.action?pageId=197493875&fileName=CN9130_SOM_REV1.1_STEP.zip) | ZIP Archive [CN9130\_SOM\_REV1.1\_STEP.zip](/wiki/download/attachments/197493875/CN9130_SOM_REV1.1_STEP.zip?api=v2) | Mar 15, 2022 by [alon rotman](/wiki/people/5f67bce7460930007791b95f) |
| Labels<br><br>- No labels<br>- [Edit Labels](#section-ccb6686b-4616-421e-9456-68b321398f9d)<br><br>[Preview] [View](/wiki/download/attachments/197493875/Reliability+prediction+for+CN9130+SOM+V1.pdf?version=1) [Properties](/wiki/pages/editattachment.action?pageId=197493875&fileName=Reliability+prediction+for+CN9130+SOM+V1.pdf&isFromPageView=true) [Delete](/wiki/pages/confirmattachmentremoval.action?pageId=197493875&fileName=Reliability+prediction+for+CN9130+SOM+V1.pdf) | PDF File [Reliability prediction for CN9130 SOM V1.pdf](/wiki/download/attachments/197493875/Reliability%20prediction%20for%20CN9130%20SOM%20V1.pdf?api=v2) | Apr 14, 2022 by [SolidRun](/wiki/people/557058:12be2ae4-3a6e-40cc-a677-bdfc4c987d1f) |
| Labels<br><br>- No labels<br>- [Edit Labels](#section-c63f7da5-25cc-4e4a-b1f3-67024fd5a9b1)<br><br>[Preview] [View](/wiki/download/attachments/197493875/CN9130_SOM_REV1.3_3D.zip?version=2) [Properties](/wiki/pages/editattachment.action?pageId=197493875&fileName=CN9130_SOM_REV1.3_3D.zip&isFromPageView=true) [Delete](/wiki/pages/confirmattachmentremoval.action?pageId=197493875&fileName=CN9130_SOM_REV1.3_3D.zip) | ZIP Archive [CN9130\_SOM\_REV1.3\_3D.zip](/wiki/download/attachments/197493875/CN9130_SOM_REV1.3_3D.zip?api=v2) | Oct 29, 2023 by [Rabeeh Khoury](/wiki/people/557058:99a92153-3f5e-430e-b8cf-907fde28b14e) |

[Download All](/wiki/download/all_attachments?pageId=197493875)
