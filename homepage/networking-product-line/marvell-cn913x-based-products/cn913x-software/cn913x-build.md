...
1. CP\_NUM:  
  ...
  2. CP\_NUM=2 - CN9131
  3. CP\_NUM=3 - CN9132
2. BOARD\_CONFIG - defines the device tree based on the platform  
  1. BOARD\_CONFIG=0 - CN9132 CEx7 based on Clearfog Eval Board
  2. BOARD\_CONFIG=1 - CN9130 SOM based on Clearfog Base
  3. BOARD\_CONFIG=2 - CN9130 SOM based on Clearfog Pro
  4. BOARD\_CONFIG=3 - CN9131 based on SolidWan
...
<a id="ddr-configuration-and-eeprom"></a>
