...
So that is a lot that you can already do on the basis of our standard image. However, to be in full control this image can be customized using our Yocto recipes that are available in our [List of SolidSense software repository](/solidsense/solidsense-software/application-development/list-of-solidsense-software-repository.md)
