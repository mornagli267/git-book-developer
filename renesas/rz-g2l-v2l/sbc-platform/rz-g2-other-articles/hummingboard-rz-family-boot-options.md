...
- Connect the USB cable and open the serial terminal. If you have trouble with this step, refer to [the serial connection article](../../../../other-articles/serial-connection.md).
