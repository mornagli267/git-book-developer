...
The following quick start guide provides background information about the [HummingBoard Ripple RZ/V2L](https://www.solid-run.com/embedded-industrial-iot/renesas-rz-family/rz-v2l-som#carrier-boards).
...
{% hint style="info" %}
Supported with RZ/V2LCSOM. For more detailed information about our SOM RZ/V2L series please visit this user manual : [RZ/V2L SOM Hardware User Manual](../com-som/rz-g2l-and-rz-v2l-som-hardware-user-manual.md) .
{% endhint %}
