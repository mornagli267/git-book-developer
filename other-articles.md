...
General guides, tutorials, and reference materials applicable across SolidRun products.

## General Guides

### [Serial Connection](other-articles/serial-connection.md)

How to establish serial console connections to SolidRun devices.

### [Flashing an SD Card](other-articles/flashing-an-sd-card.md)

Guide to flashing operating system images to SD cards.
...
Cellular modem data connection setup guide.

### [Setting TFTP Server](other-articles/setting-tftp-server.md)

TFTP server configuration for network booting and firmware updates.

### [Connecting to Wi-Fi with connmanctl](other-articles/connecting-to-wi-fi-with-connmanctl.md)

Wi-Fi configuration using connman connection manager.

### [Application Note: eMMC Lifetime Optimization](other-articles/application-note-emmc-lifetime-optimization.md)

Best practices for maximizing eMMC storage lifespan.

## Snippets

### [Snippets](homepage/other-articles/snippets.md)
